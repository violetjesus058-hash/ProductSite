...
export default function Home() {
  ...
  return <div className={`catalog-shell catalog-style-${pageStyle} type-size-${fontSizeLevel} tracking-level-${letterSpacingLevel}`}>
    ...
    <aside className="catalog-rail">
      <button className="brand-lockup" onClick={resetFilters} aria-label="Back to ALL PRODUCTS"><img src="/manus-storage/rivora-wordmark_690942a0.png" alt="RIVORA Apparel & Lifestyle" className="brand-wordmark" /></button>
