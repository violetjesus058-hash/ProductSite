...
import RivoraBrand from "@/components/RivoraBrand";
...
export default function Home() {
  ...
  return <div className={`catalog-shell catalog-style-${pageStyle} type-size-${fontSizeLevel} tracking-level-${letterSpacingLevel}`}>
    ...
    <aside className="catalog-rail">
      <button className="brand-lockup" onClick={resetFilters} aria-label="Back to ALL PRODUCTS"><RivoraBrand className="brand-wordmark" /></button>
