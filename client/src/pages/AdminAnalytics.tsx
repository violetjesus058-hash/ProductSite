...
function Ranking({ title, rows, labelKey = "name", empty = "当前周期暂无数据", periodLabel = "当前周期", periodValue = "30", onPeriodChange }: { title: string; rows: Row[]; labelKey?: "name" | "id"; empty?: string; periodLabel?: string; periodValue?: string; onPeriodChange?: (value: string) => void }) {
